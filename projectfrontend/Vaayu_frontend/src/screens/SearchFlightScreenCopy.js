...
// export default 
class SearchFlightScreenCopy extends Component {
  constructor(props) {
    super(props);
    this.state = {
      cities: [],
  ...
  searchFlight = (e) => {
    ...
    // if (!UserAPIService.isUserSignedIn()) {
  ...
  //   } else {
  //     // If user is signed in, proceed to booking page
  //     this.props.history.push('/booking', { flight });
  //   }
  // };
  ...
  render() {
    return (
      <div class="jumbotron1">
       ...
       {/* /*</div> {this.state.passengers.length > 0 && (
