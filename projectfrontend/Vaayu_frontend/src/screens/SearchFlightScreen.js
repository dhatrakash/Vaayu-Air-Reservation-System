...
export default class SearchFlightScreen extends Component {
  ...
  render() {
    return (
      <div class="jumbotron1 text-dark">
        ...
        {this.state.flights !=="Currently No Flights Available For this Route" && this.state.flights.length > 0 && (
          <div className="my-4">
            <table class="table caption-top" bgcolor="#349bff">
              <thead>
                <tr>
            ...
            {this.state.passengers.map((i) => {
              ...
              return (
                <div class="card text-center my-4">
                  <div class="card-body">
                    <h6 class="card-title bg-info text-black">Passenger {i} Details</h6>
                    {/* <form> */}
                    <div class="row-6">
                      <div class="col">
        ...
        {this.state.selectedFlight !== null && (
          ...
          <div class="row-6">
            <div class="card text-center my-4 col text-black">
              <div class="card-header text-black bg-info" >Ticket Summary</div>
              <div class="card-body">
                <p class="card-text">
            ...
            <div class="card text-center my-4 col">
              <div class="card-header text-black bg-info">Enter Card Details</div>
      ...
      {this.state.selectedFlight !== null && (
        <div className="row-6">
          <div className="card text-center my-4 col text-black">
            <div className="card-header text-black bg-info">Payment Receipt</div>
            <div className="card-body">
              <p className="card-text">
                Airline Name: {this.state.selectedFlight.airlineName}
              </p>
              <p className="card-text">
                Route : {this.state.selectedFlight.fromCity}---
                {this.state.selectedFlight.toCity}
              </p>
              <p className="card-text">Travellers: {this.state.noOfPassengers}</p>
              <p className="card-text">Passenger Name: {this.state.passengerName}</p>
              <p className="card-text">Base Fare : {this.state.baseFare}</p>
              <p className="card-text">Taxes : {this.state.taxes}</p>
              <p className="card-text">Total Fare: {this.state.totalAmount}</p>
            </div>
          </div>
        </div>
      )}
